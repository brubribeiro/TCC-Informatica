    ...
    <div class="main-wrap">
      ...
      <div class="post-content">
                <blockquote class="content-quote">                   
                    <p class="pedidofinalizado">
                    <a class="pedidofinalizado">Seu pedido foi enviado!Em breve entraremos em contato com mais informações!</a>
                    </p>  
                </blockquote> 
        </div>
...
<div id="topsearch">
    <div class="table">
        <div class="table-cell">
            <form role="search" method="get" class="searchform" action="pedidofinalizado.php">
                <div>
