            ...
            <article class="post page">
                <div class="inner">
                    ...
                    <div class="post-content">
                        <p><img class="size-full alignleft rounded" src="images/docessonhos.png" alt="docessonhosconfeitarialogo" width="300" height="300">
                            A empresa surgiu em 2003, no bairro de Pirituba, São Paulo, e tem como nome "Doces Sonhos Confeitaria". Fundada pela senhora Elisabete Gomes dos Santos tinha como fundamento inicial o sustento dos filhos com a venda de bolos e kits para festas, sem intenção de expansão. No entanto, com o passar dos anos os produtos fornecidos tornaram-se mais conhecidos pelo público resultando no aumento das vendas e sucessivamente a firmação de uma nova empresa no mercado gastronômico.
                        </p>
                            <p>Atualmente a empresa está localizada no bairro Jardim Vitória, em Caieiras-SP, atuando sem um horário definido nos períodos matutino e vespertino. A empresa abrange todas as regiões de São Paulo.</p>
                        <p>
                            <a target="_self" class="social twitter black" href="http://twitter.com/cdocessonhos"> Twitter </a>
                            <a target="_self" class="social facebook black" href="http://www.facebook.com/confeidocessonhos"> Facebook&nbsp;</a>
                            <a target="_self" class="social instagram black" href="http://www.instagram.com/confeidocessonhos">&nbsp;instagram&nbsp;</a>                            
                        </p>
                    </div>
                </div>
            </article>
...
<div id="topsearch">
    <div class="table">
        <div class="table-cell">
            <form role="search" method="get" class="searchform" action="sobrenos.php">
                <div>
