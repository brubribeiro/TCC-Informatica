      ...
      <div class="post-content">
        ...
        <div class="post-content">  
            ...
            <div class="panel-body">
                <form id="fh5co_contact_form" action="?<?php echo $acao;?>" method="post" role="form">    
                    ...
                    <div class="form-group">
                        <label>Email</label>
                            <input type="text" name="email" class="form-control" placeholder="Informe seu email" required value="<?php echo $usu->email;?>">                                     
                    </div> 
                    <div class="form-group">
                        <label>Telefone</label>
                        <input type="text" name="telefone" class="form-control" id="telefone" placeholder="Informe seu telefone" required value="<?php echo $usu->telefone;?>">                                           
                    </div>
                    <div class="form-group">
                        <label>Celular</label>
                        <input type="text" name="celular" class="form-control" id="celular" placeholder="Informe seu celular" required value="<?php echo $usu->celular;?>">   
                    </div> 
                    <div class="form-group">
                        <label>Endereço</label>
                        <input type="text" name="endereco" class="form-control" id="endereco" placeholder="Informe seu Endereço" required value="<?php echo $usu->endereco;?>">   
                    </div>
                    <div class="form-group">
                        <label>Nome de Usuário</label>
                        <input type="text" name="nomeusuario" class="form-control" id="nomeusuario" placeholder="Informe seu Nome de Usuário" required value="<?php echo $usu->nomeusuario;?>">   
                    </div>
                    <div class="form-group">
                        <label>Imagem de Perfil</label>
                        <input type="file" name="imgperfil" class="form-control" id="imgperfil" required value="<?php echo $usu->imgperfil;?>">
                    </div>
                    <div class="form-group">
                        <label>Senha</label>
                        <input type="password" name="senha" class="form-control" id="senha" placeholder="Informe sua senha" required value="<?php echo $usu->senha;?>">   
                    </div>
                    <div class="form-group">
                    ...
                    <div class="row">                        
                       <a  class="button small red" href="areacliente.php">Voltar</a><br>   
                    </div>                                                  
                    </form>
                </div>                       
        </div>
...
<div id="topsearch">
    <div class="table">
        <div class="table-cell">
            <form role="search" method="get" class="searchform" action="meusdados.php">
                <div>
