...
$acao = "acao=cadastrar_ima";
if($ima->codimagem != 0)
  $acao = "acao=atualizar_ima";
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="col-lg-12">
                ...
                <form action="?<?php echo $acao;?>" method="post" role="form" enctype="multipart/form-data">						
                         <div class="form-group">
                            ...
                            <input name="nome" class="form-control" id="nome" placeholder="Informe o título da imagem" required value="<?php echo $ima->nome;?>">                                           
                        </div>

                        <div class="form-group">
                            <label>Data</label>
                            <input type="date" name="data" class="form-control" id="data" placeholder="Informe a data" value="<?php echo $ima->data;?>">                           
                        </div>                     
                        ...
                        <input type="hidden" name="codimagem" value="<?php echo $ima->codimagem;?>">
